  ...
  return (
    <div className="App">
      <header className="App-header">
       <br></br><br></br><br></br><br></br><br></br><h1>Coda Summer Internship</h1>
      </header>

      <div className = "intro">

      <br></br>Ngorongoro Crater, Tanzania, 2016
